...
class Response
{
    ...
    public static function CREATED ($data = null, $message = null) : JsonResponse
    {
        ...
        return response()->json($res, self::HTTP_CREATED);
    }

    public static function UNAUTHORIZED ($errors = null, $message = null) : JsonResponse
    {
        $res = [
        ...
        return response()->json($res, self::HTTP_UNAUTHORIZED);
    }

    public static function UNPROCESSABLE_ENTITY ($errors = null, $message = null) : JsonResponse
    {
        $res = [
